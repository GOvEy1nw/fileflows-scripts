...
function Script() {
  ...
  // Step 3: Edit Subtitles with Subtitle Edit Docker container
  ...
  Logger.ILog('Subtitle Edit processing completed successfully for generated subtitles via Docker.');
